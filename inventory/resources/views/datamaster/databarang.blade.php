...
<head>
    ...
    <title>PT. RAFFI ENERGI RAYA</title>
    <!-- Favicon icon -->
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li class="mega-menu mega-menu-sm">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route('users')}}">Data User</a></li>
                            <li><a href="{{route('jenis')}}">Data Jenis Barang</a></li>
                            <li><a href="{{route('barang')}}">Data Barang</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="{{route('transaksi')}}" aria-expanded="false">
                            <i class="icon-speedometer menu-icon"></i><span class="nav-text">Data Transksi</span>
                        </a>
                    </li>
                    <li class="mega-menu mega-menu-sm">
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route('laporan')}}">Data Laporan</a></li>
                            <li><a href="{{route('pajak')}}">Data Laporan Pajak</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
